...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div>
                <form class="form-group" action="/boardModify" method="post">
                <table class="table table-striped row">
                    ...
                    <tr>
                        <th>제목</th>
                        <td><input class="form-control" type="text" name="subject" value="${board.bTitle}"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                    ...
                    <tr>
                        <th>암호</th>
                        <td><input class="form-control" type="password" name="password" value="${board.bPw}">
